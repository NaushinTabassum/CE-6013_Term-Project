...
so2 <-ggplot(monthly_df,aes(x=month,y=SO2, fill=year))+
  ...
  ggtitle(expression(paste("Monthly Comparison of SO"[2] ," Concentration (CAMS-2)")))+ xlab("Month")+ 
...
PM2.5 <-ggplot(monthly_df,aes(x=month,y=PM2.5, fill=year))+
  geom_bar(stat="identity",position=position_dodge())+
  ggtitle(expression(paste("Monthly Comparison of PM"[2.5] ," Concentration (CAMS-2)")))+ xlab("Month")+ 
...
PM10 <-ggplot(monthly_df,aes(x=month,y=PM10, fill=year))+
  geom_bar(stat="identity",position=position_dodge())+
  ggtitle(expression(paste("Monthly Comparison of PM"[10] ," Concentration (CAMS-2)")))+ xlab("Month")+ 
...
NO2 <-ggplot(monthly_df,aes(x=month,y=NO2, fill=year))+
  geom_bar(stat="identity",position=position_dodge())+
  ggtitle(expression(paste("Monthly Comparison of NO"[2] ," Concentration (CAMS-2)")))+ xlab("Month")+ 
  ylab(expression(paste("NO"[2] ," Concentration ( ",mu,"g/m"^3," )")))+
  geom_hline(yintercept=25, color="dark red", linetype=2, show.legend = T)+
  geom_text(aes(4.5,25,label = 25,vjust = 1.5, hjust=0),size=3,col = "dark red")+
  geom_text(aes(label=c.no2), position=position_dodge(width=0.9), vjust=-0.35, size=2,col = "black")+
  scale_fill_manual(name="", labels=c("2015", "2016", "2017", "2018", "2019", "2020"),
                     values=c("light blue", "yellow", "orange","dark orange", "maroon","red"))+ylim(c(0,110))+
  theme_bw()+
  theme(plot.title=element_text(hjust=0.5))+
  theme(legend.position = "top", 
        legend.title=element_blank(),
...
CO <-ggplot(monthly_df,aes(x=month,y=CO, fill=year))+
  geom_bar(stat="identity",position=position_dodge())+
  ggtitle(expression(paste("Monthly Comparison of CO Concentration (CAMS-2)")))+ xlab("Month")+ 
...
O3 <-ggplot(monthly_df,aes(x=month,y=O3, fill=year))+
  geom_bar(stat="identity",position=position_dodge())+
  ggtitle(expression(paste("Monthly Comparison of O"[3] ," Concentration (CAMS-2)")))+ xlab("Month")+ 
...
NO <-ggplot(monthly_df,aes(x=month,y=NO, fill=year))+
  geom_bar(stat="identity",position=position_dodge())+
  ggtitle(expression(paste("Monthly Comparison of NO Concentration (CAMS-2)")))+ xlab("Month")+ 
